    ...
    <div id="main-wrapper">
        ...
        <main class="admin-content" id="adminContent">
			...
			switch ($_GET['r'] ?? ''){
			 ...
			 case "couleurs" :
			 include("includes/couleurs.php");
			 break;

			 case "ncouleur" :
			 include("includes/ajouter_couleur.php");
			 break;

			 case "mcouleur" :
			 include("includes/modifier_couleur.php");
			 break;
			 ...
			 include("includes/export_ventes.php");
