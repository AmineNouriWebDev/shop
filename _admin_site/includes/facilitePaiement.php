...
<!-- ============================================================== -->
 <?php	if (isset($_GET['action']) && $_GET['action'] == 'supp' ) {
		...
		if(isset($_GET['ids'])) supprimerfacilitePaiement($_GET['ids']);
		  ?>
                            ...
                            <div class="card-body">Détail paiement</h4>
                                <div class="table-responsive">
                                    <table class="table color-table info-table table-bordered">
                                        ...
                                        <tbody>
                                        <?php 
								          $id_produit_get = isset($_GET['id']) ? $_GET['id'] : '';
								          $requete = 'SELECT * FROM `facilte_paiement` WHERE `idproduit` ="'.$id_produit_get.'"';
								         ...
								         ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="index.php?r=facilitePaiement&ids=<?php echo $data['id']; ?>&idpr=<?php echo $id_produit_get; ?>&action=mod" data-toggle="tooltip" data-original-title="Modifier"> <i class="fa fa-pencil text-inverse"></i></a>
                                                    <a href="index.php?r=facilitePaiement&ids=<?php echo $data['id']; ?>&idpr=<?php echo $id_produit_get; ?>&action=supp" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i></a>
                                                </td>
                                            </tr>
                                         <?php } ?>
                                        <?php } else { ?>
                                ...
                                <form method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="text-xs-right">
                                       ...
                                       <?php if(isset($_GET['action']) && $_GET['action'] == 'mod'){ ?>
                                        <input type="hidden" name="id" value="<?php echo isset($_GET['ids']) ? $_GET['ids'] : ''; ?>" />
                                        <input type="hidden" name="idpr" value="<?php echo isset($_GET['idpr']) ? $_GET['idpr'] : ''; ?>" />
