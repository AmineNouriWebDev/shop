                            ...
                            <div class="admin-card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="titre" value="<?php echo titreSocialNetwork($_GET['id']); ?>" class="admin-input" required data-validation-required-message="Ce champ est obligatoire"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Lien</label>
                                        <div class="controls">
                                            <input type="text" name="lien" value="<?php echo lienSocialNetwork($_GET['id']); ?>" class="admin-input"> </div>
                                    </div>
                                    <div class="row">
                                     <div class="col-md-6">
                                       <div class="form-group">
                                        <label>Type</label>
                                        <div class="controls">
                                            <select name="type" id="select" class="admin-input" onchange="showInput(this)">
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="icone" class="admin-input" value="<?php echo iconeSocialNetwork($_GET['id']); ?>"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Image</label>
                                         ...
                                         <?php } ?>
                                        <div class="controls">
                                            <input type="file" name="photo" class="admin-input" value=""> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-2">
                                      <div class="form-group">
                                        <label>Ordre</label>
                                        <div class="controls">
                                            <input type="text" name="ordre" value="<?php echo ordreSocialNetwork($_GET['id']); ?>" class="admin-input"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    ...
                                    <div class="text-xs-right">
                                        ...
                                        <button type="reset" class="admin-btn admin-btn-ghost" onclick="location.href='index.php?r=social_network'">Annuler</button>
