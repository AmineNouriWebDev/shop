                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tableMessages" class="table color-table info-table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Expéditeur</th>
								         ...
								         ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    <a href="javascript:void(0);" onclick="confirmGlobalDelete('index.php?r=messages&id=<?php echo afficheChamp($data['id']); ?>&action=supp')" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i></a>
                                                </td>
                                            </tr>
                                         <?php } ?>
                                        <?php } ?>
