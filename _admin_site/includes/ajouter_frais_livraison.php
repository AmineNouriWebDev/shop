                            ...
                            <div class="admin-card-body">
					            ...
					            <form action="" method="post" onSubmit="return verification(this)" enctype="multipart/form-data">
                                    <div class="form-group">
        								...
        								<div class="input row">
        								 <div class="col-md-6"><h5>Min</h5><input type="text" name="min" class="admin-input" required value="" /></div> 
                                         <div class="col-md-6"><h5>Max</h5> <input type="text" name="max" class="admin-input" required value="" /></div>
        								</div>
                                    ...
                                    <div class="form-group">
                                        <h5>Frais </h5>
                                        <div class="controls">
                                            <input type="text" name="frais" value="" class="admin-input">
                                        </div>
                                    </div>
