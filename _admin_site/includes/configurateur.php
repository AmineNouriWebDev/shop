        ...
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <div class="admin-card-actions">
                    <a href="javascript:void(0);" onclick="alert('Module de création en cours de développement. Les tests s\'effectuent sur les kits existants.')" class="admin-btn admin-btn-primary">
            ...
            <div class="admin-card-body">
                <div class="table-responsive">
                    <table class="admin-table">
                        ...
                        ?>
                            <tr>
                                <td class="text-sm text-gray-500">#<?php echo $data['id']; ?></td>
                                ...
                                <td class="text-right">
                                    <div class="action-buttons">
                                        <a href="javascript:void(0);" onclick="alert('L\'interface de modification est en cours de développement.')" class="p-1 text-blue-600 hover:text-blue-900 transition-colors" title="Modifier">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
