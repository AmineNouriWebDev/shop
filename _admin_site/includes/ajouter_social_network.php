                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Icône</label>
                                        <div class="controls">
                                            <input type="text" name="icone" class="admin-input"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
								...
								<div class="col-sm-12">
                                 <label>Image</label>
                                    <div class="form-group row">
                                     <div class="col-md-6">
                                      <div class="form-line">
                                            <input type="file" class="admin-input" name="photo" value="">
                                        </div>
                                       </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-2">
                                      <div class="form-group">
                                        <label>Ordre</label>
                                        <div class="controls">
                                            <input type="text" name="ordre" value="<?php echo afficheMaxOrdre('social_network',1); ?>" class="admin-input"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
