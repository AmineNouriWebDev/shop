                            ...
                            <div class="admin-card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 text-right mb-2">
                                        <a class="admin-btn admin-btn-primary" href="index.php?r=nfraislivraison">Ajouter une tranche</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="table" class="admin-table">
											<thead>
												<tr>
													<th>Tranches</th>
													<th>Frais</th>
											...
											?>   
												<tr>
													...
													<td class="text-nowrap">
                                                        ...
                                                        <a href="javascript:void(0);" onclick="confirmGlobalDelete('index.php?r=fraislivraison&id=<?php echo afficheChamp($data['id']); ?>&action=supp')" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i></a>
                                                    </td>
                                                </tr>
