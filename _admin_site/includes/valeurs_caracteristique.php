...
<!-- ============================================================== -->
 <?php	if (isset($_GET['action']) && $_GET['action'] == 'supp' ) {
		$idc   = $_GET['idc'];
		executeRequete("DELETE FROM `valeur_caracteristique` WHERE id = '".$_GET['idv']."'");
		  ?>
								         ...
								         ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                  <a href="javascript:void(0);" onclick="confirmGlobalDelete('index.php?r=valeurcaracteristiques&idv=<?php echo $data['id']; ?>&idc=<?php echo $_GET['id']; ?>&action=supp');" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i></a>
                                                </td>
                                            </tr>
                                         <?php } ?>
                                        <?php } else { ?>
