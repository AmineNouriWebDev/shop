                            ...
                            <div class="admin-card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                    <div class="admin-form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="titre" value="<?php echo titrePointFort($_GET['id']); ?>" class="admin-input" required data-validation-required-message="Ce champ est obligatoire"> </div>
                                    </div>
                                     ...
                                     <div class="col-md-6">
                                      <div class="admin-form-group">
                                        ...
                                        <?php if(ApercuPointFort($_GET['id'])) { ?>
                                         ...
                                         <?php } ?>
                                        <div class="controls">
                                            <input type="text" name="photo" class="admin-input" value="<?php echo ApercuPointFort($_GET['id']);?>"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-2">
                                      <div class="admin-form-group">
                                        <h5>Ordre</h5>
                                        <div class="controls">
                                            <input type="text" name="ordre" value="<?php echo OrdrePointFort($_GET['id']); ?>" class="admin-input"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                       <div class="admin-form-group">
                                        <h5>Etat</h5>
                                        <div class="controls">
                                            <select name="select" id="select" class="admin-input">
