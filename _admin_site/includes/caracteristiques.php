								         ...
								         ?>
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    <a href="javascript:void(0);" onclick="confirmGlobalDelete('index.php?r=caracteristiques&id=<?php echo afficheChamp($data['id']); ?>&action=supp')" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i></a>
                                                </td>
                                            </tr>
                                         <?php } ?>
                                        <?php } ?>
