                            ...
                            <div class="admin-card-body">
					            ...
					            <form action="" method="post" onSubmit="return verification(this)" enctype="multipart/form-data">
                                    <div class="form-group">
        								...
        								<div class="input row">
        								 <div class="col-md-6"><h5>Min</h5><input type="text" name="min" class="admin-input" required value="<?php echo minFraisLivraison($_GET['id']); ?>" /></div> 
                                         <div class="col-md-6"><h5>Max</h5> <input type="text" name="max" class="admin-input" required value="<?php echo maxFraisLivraison($_GET['id']); ?>" /></div>
        								</div>
                                    ...
                                    <div class="form-group">
                                        <h5>Frais </h5>
                                        <div class="controls">
                                            <input type="text" name="frais" value="<?php echo valeurFraisLivraison($_GET['id']); ?>" class="admin-input">
                                        </div>
                                    </div>
                                   
        							<div class="buttons">
        								<button type="submit" name="submit" class="admin-btn admin-btn-primary" >Enregistrer</button>
        								<button type="reset" class="admin-btn admin-btn-ghost"  onclick="location.href='index.php?r=fraislivraison'" >Annuler</button>
