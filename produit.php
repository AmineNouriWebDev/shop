...
$type= isset($_GET['type']) ? sanitize($_GET['type']) : '';
	...
	if($num_rows <> 0){
		if($data['id']!=""){
            ...
            // The DB now correctly saves description in description, and keywords in keywords.
            $description_db = afficheChamp($data['description']); 
            ...
            if($description_db != '') { 
                $description_page = $description_db; 
            } else { 
